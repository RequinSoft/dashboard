    ...
    <div class="card-body bg-light">
            <div class="row gx-2">             
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input class="form-control" id="domain" name="domain" type="text" value="{{ $data->domain ? $data->domain : '' }}" />
                </div>

                <div class="col-sm-6 mb-3">
                    <label class="form-label" for="event-venue">Versión</label>
                    <input class="form-control" id="version" name="version" type="text" value="{{ $data->version ? $data->version : '' }}" />
                </div>

                <div class="col-sm-6 mb-3">
                    <label class="form-label" for="event-venue">Usuario</label>
                    <input class="form-control" id="user" name="user" type="text" value="{{ $data->user ? $data->user : '' }}" />
                </div>

                <div class="col-sm-6 mb-3">
                    <label class="form-label" for="event-venue">Contraseña</label>
                    <input class="form-control" id="password" name="password" type="text" value="{{ $data->password ? $data->password : '' }}" />
                </div>


                          
                <div class="col-6 mt-2 text-end">
                    <a href="{{ route('ldap.index') }}" class="btn btn-danger btn-user btn-block">
                        Regresar
                    </a>
                </div> 
