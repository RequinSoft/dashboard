...
var totalSalesInit = function totalSalesInit() {
  ...
  var hrs = ['12', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', 
  ...
  function getFormatter(params) {
    ...
    return "".concat(hrs[1], ":").concat(minutos[0], ", ").concat(value);
  }
  ...
  if ($echartsLineTotalSales) {
    ...
    var chart = window.echarts.init($echartsLineTotalSales);
    var monthsnumber = [
      [100, 100, 80, 60, 80, 65, 130, 120, 100, 30, 40, 30], 
      [100, 100, 70, 80, 50, 120, 100, 130, 140, 90, 100, 40], 
      [100, 80, 50, 60, 40, 60, 120, 100, 130, 60, 80, 50], 
      [100, 70, 80, 100, 70, 90, 60, 80, 130, 40, 60, 50], 
      [100, 90, 40, 80, 80, 100, 140, 100, 130, 90, 60, 70], 
      [100, 80, 60, 80, 60, 40, 100, 120, 100, 30, 40, 30], 
      [100, 20, 40, 20, 50, 70, 60, 110, 80, 90, 30, 50], 
      [100, 60, 70, 30, 40, 80, 140, 80, 140, 120, 130, 100], 
      [100, 90, 90, 40, 60, 40, 110, 90, 110, 60, 80, 60], 
      [100, 50, 80, 50, 80, 50, 80, 120, 80, 50, 120, 110], 
      [100, 60, 90, 60, 70, 40, 70, 100, 140, 30, 40, 30], 
      [100, 20, 40, 20, 50, 30, 80, 120, 100, 30, 40, 30]];
      ...
      return {
        ...
        xAxis: {
          ...
          axisLine: {
            lineStyle: {
              // color: utils.getGrays()['300'],
              color: utils.rgbaColor('#000', 0.03),
              type: 'dashed'
            }
          },
          axisTick: {
        ...
        chart.setOption({
          tooltip: {
            formatter: function formatter(params) {
              ...
              var date = new Date(name);
              return "".concat(hrs[2], ":").concat(minutos[0], ", ").concat(value);
            }
          },
          xAxis: {
            axisLabel: {
              formatter: function formatter(value) {
                var date = new Date(value);
                return "".concat(hrs[3], ":").concat(minutos[0]);
              },
              margin: 15
            }
          },
